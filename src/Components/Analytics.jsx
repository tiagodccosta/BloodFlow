        ...
        <div className='w-full bg-white py-16 px-4'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <p className='md:text-1xl sm:text-1xl text-1xl py-4'>BloodFlow is here to revolutionize how standartized blood work analysis are made. Using Artificial Inteligence to 
                        extract the fulcral data points and load them in our innovative interface. Store all your blood analysis in one single place across 
