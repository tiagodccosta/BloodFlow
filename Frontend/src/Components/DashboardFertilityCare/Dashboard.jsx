            ...
            <div className="flex h-screen">
                ...
                <div id="Sidebar" className="bg-white hidden md:flex flex-col h-full md:w-1/5 sm:w-0 w-0 relative">
                    ...
                    <div className="absolute bottom-0 left-0 w-full py-4 px-4">
                        ...
                        <button className="bg-black w-full rounded-md cursor-pointer font-bold py-3 text-white" onClick={handleLogout}>
                            Logout
                        </button>
                    </div>
                </div>
                ...
                <div className={`${nav ? 'fixed' : 'hidden'} left-0 top-0 w-3/5 h-full bg-white flex flex-col ease-in-out duration-500 z-40`}>
                    ...
                    <div className="absolute bottom-0 left-0 w-full py-4 px-4">
                        <button 
                            onClick={handleAddPatientClick} 
                            className="bg-[#ff0000] text-white cursor-pointer w-full font-bold text-sm py-3 rounded-md my-2"
                        >
                            Add New Patient
                        </button>
    
                        <button className="bg-black w-full text-sm cursor-pointer rounded-md font-bold py-3 text-white" onClick={handleLogout}>
                            Logout
                        </button>
                    </div>
                </div>
                            ...
                            <>
                                ...
                                <div className="w-full md:w-1/3 p-2 md:p-6 md:pl-4 flex flex-col items-center justify-center mt-8 mb-4">
                                    ...
                                    <button 
                                        ...
                                        className="bg-[#ff0000] w-40 text-sm cursor-pointer md:w-52 rounded-md font-bold py-2 md:py-4 text-white"
                                    >
                                        Upload Blood Test
                                    </button>
                                    {showNewFileModal && (
