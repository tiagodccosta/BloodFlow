  ...
  return (
    <div className='grid h-screen w-full bg-white'>
        <div className='flex flex-col justify-center'>
            <form className='max-w-[400px] w-full mx-auto bg-white p-4 mb-10 -mt-5'>
                <img className='mx-auto w-52' src={BloodFlowLogo} alt='/' />
                <h2 className='md:text-2xl sm:text-2xl text-xl font-bold text-center -mt-5'>Create Your Account</h2>
